...
with open(p+"/data/pickled_dataset/isin_dataset_task1_no_higher_order_quantum_train_no_perm.pkl", "rb") as f:
...
train_circuits, valid_circuits, train_labels, valid_labels = get_train_valid(train_dataset, validation_dataset)
